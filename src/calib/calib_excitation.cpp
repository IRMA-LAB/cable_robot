...
void CalibExcitation::enable(CalibExcitationData* data /*= nullptr*/)
{
  if (data == nullptr)
...
void CalibExcitation::changeControlMode()
{
  CLOG(TRACE, "event") << "with NULL";
...
void CalibExcitation::changeControlMode(CalibExcitationData* data)
{
  CLOG(TRACE, "event") << "with " << *data;
...
STATE_DEFINE(CalibExcitation, Idle, NoEventData)
{
...
STATE_DEFINE(CalibExcitation, Enabled, NoEventData)
{
...
STATE_DEFINE(CalibExcitation, PosControl, NoEventData)
{
...
STATE_DEFINE(CalibExcitation, TorqueControl, CalibExcitationData)
{
...
bool CalibExcitation::readTrajectories(const QString& ifilepath)
{
...
void CalibExcitation::setCablesLenTraj(const bool relative, const vect<id_t>& motors_id,
                                       QTextStream& s)
{
...
void CalibExcitation::printStateTransition(const States current_state,
