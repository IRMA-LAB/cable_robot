    ...
    ui(new Ui::CableRobotInterface)
{
    ...
    connect(cableRobotMaster,&CableRobotMaster::SendStartUp,this,&CableRobotInterface::CollectStartUp);
    connect(cableRobotMaster,&CableRobotMaster::SendMasterRequestProcessed,this,&CableRobotInterface::CollectMasterRequestProcessed);
    connect(&cableRobotMaster->cableRobot,&CableRobot::SendRobotRequestProcessed,this,&CableRobotInterface::CollectRobotRequestProcessed);

    connect(this,&CableRobotInterface::SendMasterRequest,cableRobotMaster,&CableRobotMaster::CollectMasterRequest);
    connect(this,&CableRobotInterface::SendMotorNumber,cableRobotMaster,&CableRobotMaster::CollectMotorNumber);
    connect(this,&CableRobotInterface::SendRobotRequest,&cableRobotMaster->cableRobot,&CableRobot::CollectRobotRequest);
}

CableRobotInterface::~CableRobotInterface()
{
    delete ui;
}
...
{
    if (checked) emit SendMasterRequest(CableRobotMaster::standardRobotOperation);
    else emit SendMasterRequest(CableRobotMaster::idle);
}


void CableRobotInterface::on_UserRobotButton_toggled(bool checked)
{
    if (checked) emit SendMasterRequest(CableRobotMaster::userRobotOperation);
    else emit SendMasterRequest(CableRobotMaster::idle);
}
...
void CableRobotInterface::CollectMasterRequestProcessed(int state)
{
    ...
    case CableRobotMaster::actuatorControl : {
        ActuatorInterface* actuatorInterface = new ActuatorInterface(nullptr,cableRobotMaster);
...
void CableRobotInterface::CollectRobotRequestProcessed(int state)
{
    ...
    case CableRobot::calibration : {
        CalibrationInterface* calirationInterface = new CalibrationInterface(nullptr,cableRobotMaster);
    ...
    case CableRobot::robot33ActuatorPvt : {
        ActuatorPvtInterface33* actuatorPvtInterface33 = new ActuatorPvtInterface33(nullptr,cableRobotMaster);
    ...
    case CableRobot::robot33Manual : {
        ManualInterface33* manualInterface33 = new ManualInterface33(nullptr,cableRobotMaster);
        manualInterface33->show();
        break;
    }
    case CableRobot::robot66Manual : {
        ManualInterface66* manualInterface66 = new ManualInterface66(nullptr,cableRobotMaster);
