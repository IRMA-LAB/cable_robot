...
CableRobotMaster cableRobotMaster; // Declare master as global variable (usefull for qt signal and slot system)

int main(int argc, char *argv[])
{
    QApplication a(argc, argv); // Qt default
    CableRobotInterface cableRobotInterface(nullptr,&cableRobotMaster); //the GUI
