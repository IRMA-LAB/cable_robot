function vector = CalcDirectKinematicsLengthSwivelStatic(cdpr_p,record,parameters1,parameters2,R,variables)
...
for i=1:cdpr_p.n_cables
  cdpr_v.cable(i).length = parameters1(i);
...
for i=1:cdpr_p.n_cables
vector(cdpr_p.pose_dim++i,1) = parameters2(i)-cdpr_v.cable(i).swivel_ang;
end
end