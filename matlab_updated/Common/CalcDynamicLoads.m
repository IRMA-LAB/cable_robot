...
%   dynamic loads, projected on the global frame.
  ...
  cdpr_v.dyn_load(1:3,1) = -cdpr_p.platform.mass.*anti_omega*anti_com*cdpr_v.platform.angular_vel;
  cdpr_v.dyn_load(4:6,1) = anti_omega*cdpr_v.platform.inertia_matrix_global*cdpr_v.platform.angular_vel;
