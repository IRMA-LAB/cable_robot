function cdpr_v = CalcExternalLoadsStateSpace(cdpr_v,cdpr_p,R)
...
%   forces and moments, projected on the global frame.
  ...
  cdpr_v = CalcExternalLoads(cdpr_v,cdpr_p,R);
  cdpr_v.ext_load_ss(1:3,1) = cdpr_v.ext_load(1:3,1);
  cdpr_v.ext_load_ss(4:6,1) = cdpr_v.platform.H_mat'*cdpr_v.ext_load(4:6,1);
