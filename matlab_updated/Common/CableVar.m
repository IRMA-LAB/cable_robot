...
%       P be a platform point.
    properties
        length;%is the total cable length between the points A and D.
        ...
        vers_rho;%is a vector(size[3,1]), containing the components of the unit vector from B to A, projected on the global frame.

        % VERS_U, VERS_W and VERS_N define a right handed coordinate system.
        
        speed;% is the 1th order time derivative of LENGTH.
        ...
        vers_rho_deriv;%is a vector(size[3,1]), containing the components of the 1th order time derivatives of VERS_RHO.
        
        acceleration;% is the 2nd order time derivative of LENGTH.
    ...
    methods
        function obj = Update(obj,l,s,t)
            %UPDATE updates swivel pulley variables.
            %
