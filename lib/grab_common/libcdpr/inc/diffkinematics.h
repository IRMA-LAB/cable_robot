 ...
 * This group collects all elements related to first-order kinematics of a generic 6DoF CDPR.
 * @{
 */
 ...
 * @param[out] cable A pointer to the cable variables structure including the velocities to be
 * updated.
 */
 ...
 * @param[in] swivel_ang_dot [rad/s] Swivel angle speed @f$\dot{\sigma}@f$.
 ...
 * @param[in] tan_ang_dot [rad/s] Tangent angle speed @f$\dot{\psi}_i@f$.
 * @param[in] swivel_ang_dot [rad/s] Swivel angle speed in @f$\dot{\sigma}_i@f$.
 ...
 * @param[in] vers_rho Versor @f$\hat{\boldsymbol{\rho}}_i@f$.
 * @param[in] vel_OA_glob See @f$\dot{\mathbf{a}}_i@f$.
 * @return Cable speed in _m/s_.
 */
 ...
 * This group collects all elements related to second-order kinematics of a generic 6DoF CDPR.
 * @{
 */
 ...
 * @param[in] angles_type Desired rotation parametrization. Default is _TILT_TORSION_.
 * @param[in] pos_PG_glob [m] Global CoG position (see @f$^\mathcal{O}\mathbf{r}'@f$).
 * @param[out] platform A pointer to the platform structure including vars to be updated.
 */
 ...
 * @param[in] cable A pointer to the updated cable variables structure.
 * @return Swivel angle acceleration in _rad/s<sup>2</sup>_.
 */
 ...
 * @param[in] cable A pointer to the updated cable variables structure.
 * @return Tangent angle acceleration in _rad/s<sup>2</sup>_.
 */
