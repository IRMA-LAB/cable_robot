...
private:
    ...
    typedef void (CableRobotMaster::*StateFunction)(); // Easy way to implement state machine
    StateFunction stateMachine[numberOfMasterStates] = {&CableRobotMaster::IdleFun,
                                                        &CableRobotMaster::ActuatorControlFun,
                                                        &CableRobotMaster::EasyCatControlFun,
                                                        &CableRobotMaster::StandardRobotOperationFun,
                                                        &CableRobotMaster::UserRobotOperationFun};
    StateFunction stateManager[numberOfMasterStates] = {&CableRobotMaster::IdleTransition,
...
public:
    ...
    */
    ...
    GoldSoloWhistleDrive goldSoloWhistleSlave[GoldSoloWhistleNumber] = {{GoldSoloWhistleDrive(1)},
